	...
	: BaseApplicableConfigPanel_SpecificConfig(parent)
{
	...
	m_check_Enable->SetValue(g_Conf->gui->EnableGameFixes);
...
{
	g_Conf->gui->EnableGameFixes = m_check_Enable->GetValue();

	Pcsx2Config::GamefixOptions& opts(g_Conf->emulator->Gamefixes);
