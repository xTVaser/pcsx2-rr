	...
	: BaseApplicableConfigPanel_SpecificConfig( parent )
{
	...
	m_check_Fullscreen	= new pxCheckBox( this, _("Start in fullscreen mode by default\n") +  wxGetApp().GlobalAccels->findKeycodeWithCommandId("FullscreenToggle").toTitleizedString() );
	...
	s_AspectRatio += Label(fmt::format("{} ({})", "Aspect Ratio", wxGetApp().GlobalAccels->findKeycodeWithCommandId("GSwindow_CycleAspectRatio").toTitleizedString())) | pxMiddle;
