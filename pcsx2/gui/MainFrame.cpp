...
void MainEmuFrame::ConnectMenus()
{
	...
	Bind(wxEVT_MENU, &MainEmuFrame::Menu_Recording_Load_Savestate_Click, this, MenuId_Recording_Stop);
...

{
	...
	m_menuRecording.Append(MenuId_Recording_Load_Savestate, _("Load TAS Savestate"))->Enable(false);
	m_menuRecording.AppendSeparator();
