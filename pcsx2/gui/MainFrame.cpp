...
void MainEmuFrame::ConnectMenus()
{
	...
	Bind(wxEVT_MENU, &MainEmuFrame::Menu_Recording_Restart_Click, this, MenuId_Recording_Restart);
...

{
	...
	m_menuRecording.Append(MenuId_Recording_Restart, _("Reset to First Frame"))->Enable(false);
	m_menuRecording.AppendSeparator();
