	...
	: wxPanelWithHelpers( parent, wxVERTICAL )
{
	...
	configFile.Write( L"file:///%s/Docs/Configuration_Guide.pdf", WX_STR((wxString)InstallFolder) );
	faqFile.Write( L"file:///%s/Docs/PCSX2_FAQ.pdf", WX_STR((wxString)InstallFolder));
#else
...
void FirstTimeWizard::OnPageChanging( wxWizardEvent& evt )
{
	...
	if( evt.GetDirection() )
	{
		...
		if( page == 0 )
		{
			if( wxFile::Exists((std::string)GetUiSettingsFilename()) || wxFile::Exists((std::string)GetVmSettingsFilename()) )
			{
