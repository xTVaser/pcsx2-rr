...
void GSPanel::InitRecordingAccelerators()
{
	...
	GetMainFramePtr()->initializeRecordingMenuItem(MenuId_Recording_FrameAdvance, m_Accels->findKeycodeWithCommandId("FrameAdvance").toTitleizedString());
	GetMainFramePtr()->initializeRecordingMenuItem(MenuId_Recording_TogglePause, m_Accels->findKeycodeWithCommandId("TogglePause").toTitleizedString());
	GetMainFramePtr()->initializeRecordingMenuItem(MenuId_Recording_ToggleRecordingMode, m_Accels->findKeycodeWithCommandId("InputRecordingModeToggle").toTitleizedString());
