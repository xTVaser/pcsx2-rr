...
private:
	...
	static const int RecordingSeekpointFrameMax = sizeof(InputRecordingFileHeader);
	static const int RecordingSeekpointUndoCount = sizeof(InputRecordingFileHeader) + 4;
